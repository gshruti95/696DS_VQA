...
class RelNetBatchNorm(nn.Module):
    def __init__(self, dataset_dictionary, architecture_dictionary):
        super(RelNetBatchNorm, self).__init__()
        ...
        self.batch_norm_predict_layer = nn.Linear(ques_dim, 2 * self.filter_size) # need C gamma values and C beta values
        ...
        self.conv4 = nn.Conv2d(self.filter_size, self.filter_size, 3, stride=2, padding=1)
